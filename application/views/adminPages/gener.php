        ...
        <tbody>
          <?php foreach ($gener as $g) : ?>
            <tr>
              <td><?= $g['gener_id']; ?></td>
              <td><?= $g['gener']; ?></td>
              <td><a href="<?php echo base_url(); ?>admin_edit_gener/<?= $g['gener_id'] ?>" class="btn btn-light btn-round px-5">edit</a><a href="<?php echo base_url(); ?>admin_delete_gener/<?= $g['gener_id'] ?>" class="btn btn-light btn-round px-5 ml-1">Delete</a></td>
