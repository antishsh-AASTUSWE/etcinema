  ...
  <?php foreach ($records as $r) { ?>
    <div class="card">
      <div class="card-body">
        ...
        <?php echo form_open("admin_update_showtime/{$r['show_id']}") ?>
        ...
        <div class="form-group">
          ...
          <input type="date" name="date" max="3000-12-31" value="<?php echo $r['show_date']; ?>" placeholder="Select Date" min="1000-01-01" class="form-control">
          <div class="text-danger">
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <a href="<?php echo base_url(); ?>admin_showtime" class="btn btn-light btn-round px-5">Cancel</a>
          </div>
        </div>
      </div>
