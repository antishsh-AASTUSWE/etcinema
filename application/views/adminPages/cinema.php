        ...
        <tbody>
          <?php foreach ($cinema as $c) : ?>
            <tr>
              <td><?= $c['cinema_id']; ?></td>
              <td><?= $c['cinema_name']; ?></td>
              <td><a href="<?php echo base_url(); ?>admin_edit_cinema/<?= $c['cinema_id'] ?>" class="btn btn-light btn-round px-5">edit</a><a href="<?php echo base_url(); ?>admin_delete_cinema/<?= $c['cinema_id'] ?>" class="btn btn-light btn-round px-5 ml-1">Delete</a></td>
