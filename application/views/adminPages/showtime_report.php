...
<?php
    ...
    <div class="table-responsive">
      ...
      <a href="<?php echo base_url(); ?>admin/daily_showtime_pdfdetails" class="btn btn-light btn-round px-5 ml-1">View in PDF</a>
    </div>
...
<?php
    ...
    <div class="table-responsive">
      ...
      <a href="<?php echo base_url(); ?>admin/weekly_showtime_pdfdetails" class="btn btn-light btn-round px-5 ml-1">View in PDF</a>
    </div>
...
<div class="table-responsive">
  ...
  <a href="<?php echo base_url(); ?>admin/monthly_showtime_pdfdetails" class="btn btn-light btn-round px-5 ml-1">View in PDF</a>
</div>
