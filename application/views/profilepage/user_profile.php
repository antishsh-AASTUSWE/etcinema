            ...
            <div class="table-responsive">
                            ...
                            <div class="d-flex justify-content-center">
                                <a href="<?php echo base_url() ?>box_office" class="btn btn-light btn-round px-4 float-right">
                                    <i class="icon-lock"></i>Edit Account</a>
...
<?php if (isset($profile)) { ?>
    ...
    <label for="formGroupExampleInput"><?php echo $r['first_name']; ?></label>
    </div>
    <div class="form-group">
    <label for="formGroupExampleInput"><?php echo $r['last_name']; ?></label>
    </div>
    <div class="form-group">
    <label for="formGroupExampleInput"><?php echo $r['email']; ?></label>
    </div>
    <div class="form-group">
    <label for="formGroupExampleInput"><?php echo $r['phone']; ?></label>
    </div>
    <div class="form-group">
    <label for="formGroupExampleInput"><?php echo $r['username']; ?></label>
    </div>
                ...
                <?php echo form_open("update_customer/{$r['cust_id']}") ?>
                <form>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control form-control-rounded" id="formGroupExampleInput" value="<?php echo $r['username']; ?>" name="username" placeholder="User name">
                        <div class="text-danger">
