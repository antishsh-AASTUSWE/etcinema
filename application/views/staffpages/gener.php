<div class="card">
  <div class="card-body">
    ...
    <?php echo form_open('staff_add_gener') ?>
    <div class="row mt-3">
      <div class="col-lg-6">
        ...
        <tbody>
          <?php foreach ($gener as $g) : ?>
            <tr>
              <td><?= $g['gener_id']; ?></td>
              <td><?= $g['gener']; ?></td>
              <td><a href="<?php echo base_url(); ?>staff_edit_gener/<?= $g['gener_id'] ?>" class="btn btn-light btn-round px-5">edit</a><a href="<?php echo base_url(); ?>staff_delete_gener/<?= $g['gener_id'] ?>" class="btn btn-light btn-round px-5 ml-1">Delete</a></td>
