        ...
        <tbody>
          <?php foreach ($rating as $r) : ?>
            <tr>
              ...
              <td><a href="<?php echo base_url(); ?>staff_edit_rating/<?= $r['rating_id'] ?>" class="btn btn-light btn-round px-5">edit</a><a href="<?php echo base_url(); ?>staff_delete_rating/<?= $r['rating_id'] ?>" class="btn btn-light btn-round px-5 ml-1">Delete</a></td>
