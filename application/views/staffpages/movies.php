  ...
  <div class="card-body">
    <div class="col-lg-6">
      <div class="form-group">
        <button type="submit" class="btn btn-light btn-round px-5"><i class="icon-plus"></i> <a href="<?php echo base_url() ?>staff_add_movie">Add Movie</a></button>
      </div>
    </div>
  </div>
</div>
        ...
        <tbody>
          <?php foreach ($movie as $m) : ?>
            <tr>
              ...
              <td><a href="<?php echo base_url(); ?>staff_edit_movie/<?= $m['movie_id'] ?>" class="btn btn-light btn-round px-5">edit</a><a href="<?php echo base_url(); ?>staff_delete_movie/<?= $m['movie_id'] ?>" class="btn btn-light btn-round px-5 ml-1">Delete</a></td>
