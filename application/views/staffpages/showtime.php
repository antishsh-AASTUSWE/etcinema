<div class="card">
  <div class="card-body">
    ...
    <?php echo form_open('staff_add_showtime') ?>
    ...
    <form>
      <table class="table table-sm">
        ...
        <tbody>
          ...
          <td>
            <div class="form-group">
              <input type="date" name="date" max="3000-12-31" placeholder="Select Date" min="1000-01-01" class="form-control">
              <div class="text-danger">
          ...
          <tbody>
            ...
            <?php foreach ($showtime as $s) : ?>
              <tr>
                ...
                <td><?= $s['show_date']; ?></td>
                <td><?= $s['show_time']; ?></td>
                <td><a href="<?php echo base_url(); ?>staff_edit_showtime/<?= $s['show_id'] ?>" class="btn btn-light btn-round px-5">edit</a><a href="<?php echo base_url(); ?>staff_delete_showtime/<?= $s['show_id'] ?>" class="btn btn-light btn-round px-5 ml-1">Delete</a></td>
