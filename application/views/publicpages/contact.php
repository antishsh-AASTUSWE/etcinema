...
<section class="contact-section padding-top">
    <div class="contact-container">
        <div class="bg-thumb bg_img" data-background="<?php echo base_url() ?>publicassets/images/contact/contact.jpg"></div>
        <div class="container">
                        ...
                        <div class="info-area">
                            <div class="info-item">
                                <div class="info-thumb">
                                    <img src="<?php echo base_url() ?>publicassets/images/contact/contact01.png" alt="contact">
                                </div>
                            ...
                            <div class="info-item">
                                <div class="info-thumb">
                                    <img src="<?php echo base_url() ?>publicassets/images/contact/contact02.png" alt="contact">
                                </div>
                                <div class="info-content">
