...
(124, 1, 8, 2, '100', '2021-01-19 12:23:08', 'expired', 1),
(125, 9, 8, 2, '110', '2021-01-19 13:48:08', 'expired', 1),
...
(380, 1, '35', '2021-01-19 12:22:33', 124),
(381, 1, '36', '2021-01-19 12:22:33', 124),
(382, 9, '17', '2021-01-19 13:47:58', 125),
(383, 9, '27', '2021-01-19 13:47:59', 125),
(384, 1, '47', '2021-01-19 14:58:35', 126),
(385, 1, '57', '2021-01-19 14:58:35', 126),
(386, 1, '48', '2021-01-19 15:01:55', 127),
(387, 1, '59', '2021-01-19 15:01:55', 127),
(388, 1, '510', '2021-01-19 15:01:55', 127),
(389, 1, '48', '2021-01-19 15:03:04', 128),
(390, 1, '59', '2021-01-19 15:03:04', 128),
...
ALTER TABLE `booking_info`
  ...
  ADD CONSTRAINT `booking_info_ibfk_3` FOREIGN KEY (`paid_bank`) REFERENCES `bank` (`bank_id`),
  ADD CONSTRAINT `booking_info_ibfk_4` FOREIGN KEY (`user_id`) REFERENCES `customer` (`cust_id`);
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `change_status` ON SCHEDULE EVERY 60 MINUTE STARTS '2021-01-19 14:09:38' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE cinemaet.booking_info set status='expired'$$
